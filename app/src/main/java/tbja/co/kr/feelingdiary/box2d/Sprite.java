...
public class Sprite {
    ...
    public void Draw(Vec2 position, float rotation, float scale,Matrix4f view)
    {
        ...
        //Log.d("aaa",position + "==" + (float) DrawTexture.GetWidth() * scale + "==" + (float) DrawTexture.GetHeight() * scale);
    ...
    public float getWidth() {
        return (float) DrawTexture.GetWidth();
    }

    public float getHeight() {
        return (float) DrawTexture.GetHeight();
    }
}
